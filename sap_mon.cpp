...
//Execute example:
//./sap_mon -show -username=<USER> -password=<PASSWORD> -hostname=<HOSTANAME> -sid=<SAP-SID> -sysnum=01 -client=<CLIENT NUMBER>
//./sap_mon -check -username=<USER> -password=<PASSWORD> -hostname=<HOSTANAME> -sid=<SAP-SID> -sysnum=01 -client=<CLIENT NUMBER> -monitor='<SAP-SID>\<HOSTANAME>_<SAP-SID>_01\OperatingSystem\Filesystems\/tmp\Freespace' -warn=4000 -critical=2999
//./sap_mon -aborted-job -username=<USER> -password=<PASSWORD> -hostname=<HOSTANAME> -sid=<SAP-SID> -sysnum=01 -client=<CLIENT NUMBER> 
